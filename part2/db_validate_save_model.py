...
rf_pipeline_load = joblib.load("db_rf_pipeline.joblib")

load_train_pred = pipeline_load.predict(X_train)
load_valid_pred = pipeline_load.predict(X_valid)
rf_load_train_pred = rf_pipeline_load.predict(X_train)
rf_load_valid_pred = rf_pipeline_load.predict(X_valid)
