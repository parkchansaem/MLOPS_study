...
rf_model_pipeline_load = joblib.load("rf_model_pipeline.joblib")

load_train_pred = model_pipeline_load.predict(X_train)
load_valid_pred = model_pipeline_load.predict(X_valid)
rf_load_train_pred = rf_model_pipeline_load.predict(X_train)
rf_load_valid_pred = rf_model_pipeline_load.predict(X_valid)
